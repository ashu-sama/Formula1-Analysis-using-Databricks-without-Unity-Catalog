...
drivers_df = (
    spark.read.format("delta").load(f"{processed_folder_path}/drivers")
...
merge_delta_tbl(final_df, "f1_presentation", "race_results", presentation_folder_path, merge_condition, "race_id")
